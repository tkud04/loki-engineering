...
<div class="social_wrap">
    ...
    <ul id="top_line_nav" class="top_line_nav">
      <li id="menu-item-3099" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3099"><a href="{{url('about')}}"><span class="nav_item_wrap">About Us</span></a></li>
      <li id="menu-item-3084" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3084"><a href="{{url('contact')}}"><span class="nav_item_wrap">Contact Us</span></a></li>
</ul>
</div></nav></div></div></div></div><div class="header_top_but closed"><span class="cmsmasters_theme_icon_slide_bottom"></span></div></div><div class="header_mid" data-height="150"><div class="header_mid_outer"><div class="header_mid_inner"><div class="logo_wrap"><a href="{{url('/')}}" title="Style-1" class="logo">
